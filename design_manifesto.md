...
Do not gather, store, or distribute users’ data without explicit consent
...
Do not perform any kind of experimentation or research involving the users without their explicit consent
...
Be sure the design is accessible to every possible user, such that it never ostracizes or excludes anyone
...
Always put the users’ needs and wants first
